      ...
      return <div className="hot-area uk-box-shadow-large">
         ...
         <div className="btn uk-grid-small uk-child-width-expand@s" data-uk-grid>
            <div className="uk-width-1-1 uk-width-1-3@s uk-text-center uk-text-left@s">
               <button onClick={this.gotoManual} className="uk-button uk-button-default uk-margin-medium-right@s uk-box-shadow-hover-large start-btn">Get Started</button>
            </div>
            <div className="uk-width-1-1 uk-width-1-3@s uk-text-center uk-text-left@s">
               <button className="uk-button uk-button-default github-repo-btn" onClick={this.gotoGitee}>Gitee Repo</button>
            </div>
            <div className="uk-width-1-1 uk-width-1-3@s uk-text-center uk-text-left@s">
               <button className="uk-button uk-button-default github-repo-btn" onClick={this.gotoGithub}>GitHub Repo</button>
            </div>
         </div>
      </div>;
   }
